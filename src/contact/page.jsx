...
function Contact() {
    return (
        <>
            <Header />
            <section className="relative py-10 overflow-hidden bg-black sm:py-16 lg:py-24 xl:py-32 xl:pl-[40%] lg:mt-[5%] mt-[15%]">
                <div className="absolute inset-0 bg-cover">
                    <img className="object-cover w-full h-full md:object-left md:scale-100 md:origin-top-left" src="dormitorio.jpg" alt="" />
                </div>
                ...
                <div className="relative px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="text-center md:w-2/3 lg:w-1/2 xl:w-1/3 md:text-left">
                        ...
                        <p className="mt-4 text-base text-gray-200">¡Contáctanos para obtener más información sobre nuestros productos textiles de alta calidad!</p>
