...
function About() {
    ...
    return (
        <>
            <Header />
            <section className="py-10 bg-[#8a7862] lg:py-0">
                    ...
                    <div className="grid items-stretch grid-cols-1 lg:grid-cols-2 ">
                        <div className="h-full pr-12 lg:order-2 lg:mb-40 lg:mt-20 lg:ml-10 ">
                            <div className="relative h-full lg:h-auto  ">
                                <div className="absolute w-full h-full mb-12 overflow-hidden bg-gradient-to-r from-[#b5ba98] to-[#ebdecf] top-12 left-12 xl:left-16 lg:top-0  lg:scale-y-100 lg:origin-top ">
                        ...
                        <div className="flex items-center justify-start py-10 mt-28 lg:order-1 sm:py-16 md:mt-20 sm:mt-10  lg:py-24 xl:py-24">
                            <div>
                                <p className="text-sm font-semibold tracking-widest text-[#4f4437] uppercase">Dejanos ser tu guia en la búsqueda de la perfección para tu hogar</p>
