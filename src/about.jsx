            ...
            <section className="py-10 bg-gray-800 lg:py-0">
                <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
                    <div className="grid items-stretch grid-cols-1 lg:grid-cols-2 ">
                        ...
                        <div className="flex items-center justify-start py-10 lg:order-1 sm:py-16 md:mt-3  lg:py-24 xl:py-24">
                            <div>
                                ...
                                <p className="text-xl leading-relaxed text-gray-200 mt-9">Sumergete en el mundo de diseño de interiores de lujo con David Sanchez.
                                    Desde magestusosas piezas de mobiliraio hasta accesorios ezquisitamente
                                    elaborados. </p>
