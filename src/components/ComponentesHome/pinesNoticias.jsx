            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-4 gap-8">
                ...
                <div className="flex flex-col gap-4">
                    <div className="relative">
                        <img
                            src="https://bassari.eu/ImagenesTelasCjmw/Carruseles/ARENA/ArenaCarrusel4.webp"
                ...
                <div className="flex flex-col gap-4">
                    <div className="relative">
                        <img
                            src="https://bassari.eu/ImagenesTelasCjmw/Carruseles/HARBOUR/HarbourCarrusel1.webp"
                ...
                <div className="flex flex-col gap-4">
                    <div className="relative">
                        <img
                            src="https://bassari.eu/ImagenesTelasCjmw/Carruseles/ARENA/ArenaCarrusel2.webp"
                ...
                <div className="flex flex-col gap-4">
                    <div className="relative">
                        <img
                            src="https://bassari.eu/ImagenesTelasCjmw/Carruseles/ARENA/ArenaCarrusel3.webp"
