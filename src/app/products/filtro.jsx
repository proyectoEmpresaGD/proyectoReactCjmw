...
function Filtro() {
    ...
    return (
        <>
            <div  onClick={() => setIsModalOpen(true)} className="top-[12%] xl:top-[20%] sticky xl:ml-2 z-10 xl:mt-4 mt-4 ml-5">
                <button className="flex p-3 xl:px-6 lg:px-6 max-w-[30%] lg:min-w-[8%] xl:w-[7%] xl:hover:w-[9%] hover:max-w-[30%] bg-black hover:bg-white text-white hover:text-black duration-200 border-2 border-black hover:border-gray-400 hover:rounded-xl rounded">Filtros <img src="filtro.svg" className=" w-4 h-4 ml-2 mt-1" alt="" /></button>
            </div>
                <FiltroModal
                isOpen={isModalOpen}
